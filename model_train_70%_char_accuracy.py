...
def train_model(model, dataloader, criterion, optimizer, num_epochs, characters):
    train_losses = []
    ...
    return train_losses, train_word_accuracies, train_char_accuracies



def plot_metrics(train_losses, train_word_accuracies, train_char_accuracies):
    ...
    # Word accuracy plot
    plt.subplot(1, 3, 2)
    plt.plot(epochs, train_word_accuracies, label="Word Accuracy")
    ...
    plt.subplot(1, 3, 3)
    plt.plot(epochs, train_char_accuracies, label="Character Accuracy")
...
if __name__ == '__main__':
    ...
    train_losses, train_word_accuracies, train_char_accuracies = train_model(
        model, dataloader, criterion, optimizer, num_epochs=300, characters=characters
    )

    # Plot metrics
    plot_metrics(train_losses, train_word_accuracies, train_char_accuracies)
